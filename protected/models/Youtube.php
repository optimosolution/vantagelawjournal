...
class Youtube extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('published, created_by, district, thana, featured', 'numerical', 'integerOnly' => true),
            array('youtube_id', 'length', 'max' => 100),
            array('created_on', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, youtube_id, published, created_on, created_by, district, thana, featured', 'safe', 'on' => 'search'),
        );
    }
