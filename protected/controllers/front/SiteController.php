...
class SiteController extends Controller {
    ...
    public function actionIndex() {
        ...
        Yii::app()->clientScript->registerMetaTag(Yii::app()->name . ' - is a legal publication, providing expert legal scholarship, analysis, and commentary.', 'description');
        Yii::app()->clientScript->registerMetaTag('Dhaka, Bangladesh, Law, Vantage Law Journal, Law Journal, Journal, Online Journal, Bangladesh Journal, Bangladesh Law Journal', 'keywords');
        //Recent news
